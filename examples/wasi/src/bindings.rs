...
#[doc(hidden)]
macro_rules! __export_world_example_world_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_example_world_cabi;
#[repr(align(4))]
...
macro_rules! __export_example_world_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_example_world_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:example:host:example-world:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 187] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x078\x01A\x02\x01A\x03\x01\
j\x01s\x01s\x01@\0\0\0\x04\0\x03run\x01\x01\x04\0\x1aexample:host/example-world\x04\
\0\x0b\x13\x01\0\x0dexample-world\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
